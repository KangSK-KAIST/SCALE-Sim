...
flags.DEFINE_string("arch_config", "./configs/scale.cfg",
                    "file where we are getting our architechture from")
flags.DEFINE_string(
    "network", "./topologies/conv_nets/alexnet.csv", "topology that we are reading")
...
class scale:
    ...
    def run_sweep(self):
        ...
        all_arr_dim_list = [1, 2, 4, 8, 16, 32, 64, 128,
        ...
        for df in data_flow_list:
            ...
            for i in range(len(arr_h_list)):
                ...
                self.run_name = net_name + "_" + df + "_" + \
                    str(self.ar_h_min) + "x" + str(self.ar_w_min)
